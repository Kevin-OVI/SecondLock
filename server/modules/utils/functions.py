...
async def load_json_request(request: CustomRequest) -> Any:
    if request.content_type != "application/json":
        raise CustomHTTPException.only_explain(HTTPStatus.EXPECTATION_FAILED, "JSON content type expected")
    try:
...
def relative_path_walk(real_path: str, *, relative_path: str = "", relative_path_separator: str = "/"):
...
def translate_path(base_path: str, request: CustomRequest, append_index_html: bool = True, path_prefix: str = None) -> tuple[str, bool]:
